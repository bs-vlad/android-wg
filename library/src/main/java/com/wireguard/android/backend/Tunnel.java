...
public interface Tunnel {
    ...
    Pattern NAME_PATTERN = Pattern.compile("[a-zA-Z0-9_=+.-]{1," + NAME_MAX_LENGTH + "}");

    static boolean isNameValid(final CharSequence name) {
        return NAME_PATTERN.matcher(name).matches();
    }

    /**
     * Get the name of the tunnel, which should always pass the isNameValid test.
     *
